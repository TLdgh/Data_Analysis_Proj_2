...
```{r}
# Test Case
old_distinct1<-data.frame(Id=1:100, converted=rbinom(100, 1, 0.12))
new_distinct1<-data.frame(Id=1:100, converted=rbinom(100, 1, 0.12))

my_instance <- BayesianSample$new(old_distinct=old_distinct1, new_distinct=new_distinct1,rows_per_subset = 10,
                           alpha_prior_old=2,
                           alpha_prior_new=2,
                           beta_prior_old=20,
                           beta_prior_new=20)
...
#
old_distinct2<-data.frame(Id=1:100, converted=rbinom(100, 1, 0.12))
new_distinct2<-data.frame(Id=1:100, converted=rbinom(100, 1, 0.12))

my_instance <- BayesianSample$new(old_distinct=old_distinct2, new_distinct=new_distinct2,rows_per_subset = 10,
                           alpha_prior_old=19,
                           alpha_prior_new=20,
                           beta_prior_old=19,
                           beta_prior_new=20)
