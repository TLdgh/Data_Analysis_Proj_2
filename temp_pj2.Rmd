...
# calculate posterior
posterior_old <- rbeta(100, alpha_prior + conversion_old, beta_prior + visitor_to_old - conversion_old)
posterior_new <- rbeta(100, alpha_prior + conversion_new, beta_prior + visitor_to_new - conversion_new)
