...
```{r}
visitor_to_old <- 145274
visitor_to_new <- 145310
conversion_old <- 17489
conversion_new <- 17264

alpha_prior <- 2
beta_prior <- 20

# calculate posterior
posterior_old <- rbeta(100000, alpha_prior + conversion_old, beta_prior + visitor_to_old - conversion_old)
posterior_new <- rbeta(100000, alpha_prior + conversion_new, beta_prior + visitor_to_new - conversion_new)
