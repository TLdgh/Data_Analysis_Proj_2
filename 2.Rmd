...
```{r}
#Mean_old & 95% CI Plot
quantile0.025 <- quantile(frame1$mean_old, 0.025)
quantile0.975 <- quantile(frame1$mean_old, 0.975)

confidence_data <- data.frame(
  size = frame1$size,
  quantile0.025 = quantile0.025,
  mean_old = frame1$mean_old,
  mean_new = frame1$mean_new,
  quantile0.975 = quantile0.975,
  se_mean_old = frame1$se_mean_old,
  se_mean_new = frame1$se_mean_new
)
...
```{r}
#Mean_new & 95% CI Plot
quantile0.025_new <- quantile(frame1$mean_new, 0.025)
quantile0.975_new <- quantile(frame1$mean_new, 0.975)
